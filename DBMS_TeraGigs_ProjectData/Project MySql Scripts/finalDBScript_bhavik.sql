...
-- -----------------------------------------------------
-- Table `teragigsdb`.`invoice_mstr`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `teragigsdb`.`invoice_mstr` (
  `invoice_num` VARCHAR(10) NOT NULL COMMENT '',
  `sender_code` VARCHAR(10) NOT NULL COMMENT '',
...
CREATE INDEX `fk_idx` ON `teragigsdb`.`invoice_mstr` (`sender_code` ASC)  COMMENT '';
...
-- -----------------------------------------------------
-- Table `teragigsdb`.`zipcode_mstr`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `teragigsdb`.`zipcode_mstr` (
  `zip` INT(5) NOT NULL COMMENT '',
